...
class Test(unittest.TestCase):
    ...
    def test1(self):
        ...
        self.assertRaises(
            ...
            f'{currdir}jsondata1.jsn',
            f'{currdir}jsondata2.jsn',
            exact=True,
        )
    ...
    def test2(self):
        ...
        pyutilib.misc.compare_json_files(
            f'{currdir}jsondata1.jsn', f'{currdir}jsondata2.jsn', exact=False
        )
    ...
    def test5(self):
        ...
        pyutilib.misc.compare_json_files(
            f'{currdir}jsondata1.jsn', f'{currdir}jsondata1.jsn', exact=True
        )
    ...
    def test7(self):
        ...
        pyutilib.misc.compare_json_files(
            f'{currdir}jsondata6.jsn', f'{currdir}jsondata5.jsn', exact=False
        )
    ...
    def test8(self):
        ...
        self.assertRaises(
            IOError,
            pyutilib.misc.compare_json_files,
            f'{currdir}jsondata5.jsn',
            f'{currdir}jsondata6.jsn',
            exact=False,
        )
    ...
    def test15a(self):
        ...
        pyutilib.misc.compare_json_files(
            f'{currdir}jsondata2.jsn', f'{currdir}jsondata2.jsn.gz', exact=True
        )

    def test15b(self):
        # Verify that compressed files can be compared
        pyutilib.misc.compare_json_files(
            f'{currdir}jsondata2.jsn.gz', f'{currdir}jsondata2.jsn', exact=True
        )
